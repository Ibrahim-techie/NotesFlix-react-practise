  ...
  return (
    <article className="w-full rounded-lg bg-white/5 border border-white/6 p-4 shadow-sm">
      ...
      <footer className="mt-4 flex items-center justify-between gap-10 w-full">
        <button className="text-xl text-shadow-white rounded w-1/2 hover:underline hover:bg-indigo-300 bg-indigo-400 hover:scale-95 cursor-pointer"
        onClick={()=>{
          onedit(id);
        }}> 
          Edit
        ...
        <button
          className="text-xl  text-shadow-white  rounded bg-red-600 w-1/2 hover:underline hover:scale-95 hover:bg-red-400 cursor-pointer"
          onClick={() => ondelete(id)}
        >
          Delete
        </button>
